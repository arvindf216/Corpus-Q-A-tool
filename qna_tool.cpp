...
void QNA_tool::query(string question, string filename1, string filename2, string one_more_file, string filename3){
    ...
    query_llm(filename1, filename2, one_more_file, t, 5, "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", "AIzaSyCC-Fe72-Ibmd8_ArIEQHdfiZnNfJM2WK8", question, filename3, "example12768@gmail.com", "COL106_hugchat");
...
void QNA_tool::query_llm(string filename1, string filename2, string one_more_file, Node* root, int k, string API_KEY_GPT, string API_KEY_PALM, string question, string filename3, string email, string pswd){
    ...
    outfile << "\nIt is not neccesary to use all the five excerpts provided to answer the question. I want youo to use only the most relevant information in the excerpt to anwer the question.";
    outfile << "\nDO NOT PROVIDE ANY NOTES, or your opinions about the answer of the question. I want you to just output the answer.";
    outfile << "\nTemperature = 0.4";
    outfile << "\nTop_p = 0.5";
    ...
    // fhandle1 << "\nb) ";
    // fhandle1.close();
    ofstream out("query.txt", std::ios::out); out << "I am giving you 5 paragraphs. I want you to output lines from these 5 paragraphs only which are relevant to the query. DO NOT PROVIDE ANY COMMENTS OR YOUR OWN OPINION. YOU ARE NOT PERMITTED TO USE INTERNET OR ANY DATABASE as a source and use the 5 paragraphs i give you as source."; out.close();
    string cmd2 = "python3 ";
    cmd2 += filename2;
    cmd2 += " ";
    cmd2 += API_KEY_PALM;
